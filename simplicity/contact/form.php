...
$script_path = 'http://www.simplicity.org.pl/contact/form.php';
...
$recipients = 'info@simplicity.org.pl';
...
$form_struct = '
	...
	type=select|class=fmselect|label=About|fieldname=fm_about|req=true|data=(select),Idea for a Project,Seeking Funding for a Project,Cooperation & Partnership,About the Simplicity Foundation
	type=text|class=fmtext|label=Name of the Organization|fieldname=fm_who|max=100|req=no
	type=text|class=fmtext|label=Website|fieldname=fm_domain|max=100|req=no
	...
	type=textarea|class=fmtextarea|label=Message|fieldname=fm_message|max=3000|rows=10|req=true
';
...
$sent_message = '<p align="center">Thank you - your message has been sent.<br/>Go back to <a href="/index.html">the main page</a></p>';
...
.style19 {padding-left: 10px; font-weight: bold; }
a.menusmall:link {
	color:#FF9900;
	text-decoration:none
}
a.menusmall:visited {color:#FF9900;
			text-decoration:none}
a.menusmall:hover {
	color: #006666;
	text-decoration: none;}
...
<body>
<table border="0" cellpadding="5" cellspacing="2" align="center" width="640">
  <tr valign="top">
    <th class="head" colspan="2" scope="row"><div align="right"><img src="/images/simple.jpg" width="302" height="84" /></div></th>
  </tr>
  <tr>
    <td width="480" scope="row" align="left" class="maintext">
<p>
<div align="center">
<div style="margin: 0 auto 0 auto; text-align:left;">
...
?>
    ...
    <td scope="row" valign="top"><br/><br/><br/><div><table width="140" border="1" bordercolor="#FF6699">
      <td class="menu"  align="right">
      <p><a href="/index.html" class="menu1">Mainpage</a></p>
      <p><span class="menu1">About</span><br/><span class="menu2">
      KRS: 0000318048<br/>
      NIP: 8971747444<br/>
      REGON: 020871660</span><br/>
      <a href="/about.html" class="menusmall">more</a></p>
<p><span class="menu1">Download</span><br/><span class="menu2">
      <a href="/download/Statut_Simplicity.pdf">Statut</a></span>
      </p>
      </td>
    </table></div>
...
<input type="hidden" name="hosted_button_id" value="EV3XXJXUBH8MG">
